...
module.exports = class extends Generator {
    ...
    initializing() {
        this.config.set("solutionName", "Sample");
        this.config.set("solutionShortName", "Sample");
    }
    ...
    writing() {
        template: {
            ...
            // this.fs.delete(this.templatePath('temp/**/obj/**/*.*'));
            // this.fs.delete(this.templatePath('temp/**/bin/**/*.*'));
